...
void BOARD_CameraPins(void)
{
    ...
    GPIO_PinInit(BOARD_CAMERAPINS_CAM_PDWN_GPIO, BOARD_CAMERAPINS_CAM_PDWN_PIN, &CAM_PDWN_config);
    ...
    GPIO_PinInit(BOARD_CAMERAPINS_CAM_RST_GPIO, BOARD_CAMERAPINS_CAM_RST_PIN, &CAM_RST_config);
    ...
    PORT_SetPinMux(BOARD_CAMERAPINS_CAM_PDWN_PORT, BOARD_CAMERAPINS_CAM_PDWN_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_CAMERAPINS_CAM_RST_PORT, BOARD_CAMERAPINS_CAM_RST_PIN, kPORT_MuxAlt0);
