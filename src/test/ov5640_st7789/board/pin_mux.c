...
- {pin_num: P2, pin_signal: PIO4_1/TRIG_IN7/FC2_P1/CT_INP17/EZH_PIO25/PLU_IN1, label: 'P4_1/J8[3]/SJ15[1]', identifier: FRAME_DEBUG}
...
void BOARD_InitDebugConsolePins(void)
{
    ...
    gpio_pin_config_t BACK_LIGHT_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PIO1_12 (pin D2)  */
    GPIO_PinInit(BOARD_INITDEBUGCONSOLEPINS_BACK_LIGHT_GPIO, BOARD_INITDEBUGCONSOLEPINS_BACK_LIGHT_PIN, &BACK_LIGHT_config);

    /* PORT1_12 (pin D2) is configured as PIO1_12 */
    PORT_SetPinMux(BOARD_INITDEBUGCONSOLEPINS_BACK_LIGHT_PORT, BOARD_INITDEBUGCONSOLEPINS_BACK_LIGHT_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_INITDEBUGCONSOLEPINS_DEBUG_UART_RX_PORT, BOARD_INITDEBUGCONSOLEPINS_DEBUG_UART_RX_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(BOARD_INITDEBUGCONSOLEPINS_DEBUG_UART_TX_PORT, BOARD_INITDEBUGCONSOLEPINS_DEBUG_UART_TX_PIN, kPORT_MuxAlt2);
...
void BOARD_LPSPI1(void)
{
    ...
    GPIO_PinInit(BOARD_LPSPI1_LCD_RS_GPIO, BOARD_LPSPI1_LCD_RS_PIN, &LCD_RS_config);
    ...
    GPIO_PinInit(BOARD_LPSPI1_LCD_RES_GPIO, BOARD_LPSPI1_LCD_RES_PIN, &LCD_RES_config);

    gpio_pin_config_t CAM_DEBUG_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO4_0 (pin P1)  */
    GPIO_PinInit(BOARD_LPSPI1_CAM_DEBUG_GPIO, BOARD_LPSPI1_CAM_DEBUG_PIN, &CAM_DEBUG_config);

    gpio_pin_config_t FRAME_DEBUG_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO4_1 (pin P2)  */
    GPIO_PinInit(BOARD_LPSPI1_FRAME_DEBUG_GPIO, BOARD_LPSPI1_FRAME_DEBUG_PIN, &FRAME_DEBUG_config);
    ...
    PORT_SetPinMux(BOARD_LPSPI1_LCD_RS_PORT, BOARD_LPSPI1_LCD_RS_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinConfig(BOARD_LPSPI1_LED_GREEN_PORT, BOARD_LPSPI1_LED_GREEN_PIN, &LED_GREEN);

    /* PORT0_28 (pin E8) is configured as PIO0_28 */
    PORT_SetPinMux(BOARD_LPSPI1_LCD_RES_PORT, BOARD_LPSPI1_LCD_RES_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_LPSPI1_CAM_DEBUG_PORT, BOARD_LPSPI1_CAM_DEBUG_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(BOARD_LPSPI1_FRAME_DEBUG_PORT, BOARD_LPSPI1_FRAME_DEBUG_PIN, kPORT_MuxAlt0);
